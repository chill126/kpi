...
describe('UserChip', () => {
  it('renders display name and role in the trigger', () => {
    wrap(<UserChip displayName="Chris Hill" email="chris@k2.com" role="Manager" onSignOut={vi.fn()} />)
  ...
  it('invokes onSignOut when the Sign out menu item is selected', async () => {
    ...
    wrap(<UserChip displayName="Chris Hill" email="chris@k2.com" role="Manager" onSignOut={onSignOut} />)
    await userEvent.click(screen.getByRole('button', { name: /chris hill/i }))
